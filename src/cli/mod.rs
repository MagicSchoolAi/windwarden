...
#[command(long_about = "WindWarden is a blazing fast CLI tool that automatically sorts Tailwind CSS classes according to the official recommended order. It uses AST parsing to handle JSX attributes, utility functions like cn() and clsx(), template literals, and arrays.")]
...
pub struct Cli {
    ...
    #[arg(long, help = "Exit with code 1 if files need formatting, 0 if already formatted")]
...
pub enum Commands {
    ...
    Format {
        ...
        #[arg(required = true, help = "Paths to files, directories, or glob patterns (e.g., 'src/**/*.tsx')", value_name = "PATH")]
        paths: Vec<String>,
        ...
        #[arg(long, help = "Number of threads to use (overrides --processing)", value_name = "N")]
        threads: Option<usize>,
        
        /// File extensions to include
        #[arg(long, value_delimiter = ',', help = "Comma-separated list of file extensions", value_name = "EXT")]
        extensions: Option<Vec<String>>,
        
        /// Patterns to exclude from processing
        #[arg(long, value_delimiter = ',', help = "Comma-separated glob patterns to exclude", value_name = "PATTERN")]
        exclude: Option<Vec<String>>,
        
        /// Maximum directory traversal depth
        #[arg(long, help = "Maximum depth when traversing directories", value_name = "DEPTH")]
    ...
    Check {
        ...
        #[arg(required = true, help = "Paths to check for proper formatting", value_name = "PATH")]
        paths: Vec<String>,
...
pub enum ConfigAction {
    ...
    Init {
        ...
        #[arg(long, default_value = ".windwarden.json", help = "Path for the new configuration file", value_name = "FILE")]
        path: PathBuf,
    },
