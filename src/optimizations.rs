...
impl StringPool {
    pub fn new() -> Self {
        ...
        let common = [
            ...
            "bg-white", "bg-gray-100", "bg-gray-200", "bg-blue-500",
            "text-black", "text-white", "text-gray-500", "text-gray-900",
            "rounded", "rounded-md", "rounded-lg", "rounded-xl",
            "shadow", "shadow-sm", "shadow-md", "shadow-lg",
            "border", "border-2", "border-gray-200", "border-gray-300",
            "w-full", "h-full", "max-w-md", "max-w-lg", "max-w-xl",
        ];
...
mod tests {
    ...
    fn test_fast_path_optimizer() {
        assert!(FastPathOptimizer::needs_processing(r#"<div className="p-4 m-2 bg-red-500">Test</div>"#));
        assert!(!FastPathOptimizer::needs_processing(r#"<div>No classes here</div>"#));
        assert!(!FastPathOptimizer::needs_processing(r#"<div className="single-class">Test</div>"#));
    }
