...
fn test_file_not_found_error() {
    ...
    cmd.arg("format")
        ...
        .assert()
        .failure()
        .stderr(predicate::str::contains("File not found: nonexistent_file.tsx"))
        .stderr(predicate::str::contains("Suggestion: Check that the file path is correct"));
}
...
fn test_invalid_thread_count_zero() {
    ...
    cmd.arg("format")
        ...
        .stderr(predicate::str::contains("Check your command line arguments"));
}
