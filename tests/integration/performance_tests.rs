...
"#,
        ...
        fs::write(temp_dir.path().join(format!("Component{}.tsx", i)), content)
...
fn test_large_file_processing() {
    ...
    fs::write(temp_dir.path().join("large_file.tsx"), large_content)
...
fn test_glob_pattern_performance() {
    ...
    let patterns = ["**/*.tsx", "Component*.tsx", "**/Component[0-9].tsx"];
